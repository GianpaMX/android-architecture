...
class ViewModelFactory(val dateTimeProvider: DateTimeProvider, val saveFormUseCase: SaveFormUseCase, val getFormUseCase: GetFormUseCase, val versionProvider: VersionProvider, val getImagesUseCase: GetImagesUseCase) : ViewModelProvider.Factory {
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        when {
            ...
            modelClass.isAssignableFrom(GalleryViewModel::class.java) -> return GalleryViewModel(getFormUseCase, getImagesUseCase) as T
