...
class ViewModelFactory(val dateTimeProvider: DateTimeProvider, val saveFormUseCase: SaveFormUseCase) : ViewModelProvider.Factory {
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(FormViewModel::class.java)) {
            return FormViewModel(dateTimeProvider, saveFormUseCase) as T
        }
